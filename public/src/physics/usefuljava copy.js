...
let textureLoader = new THREE.TextureLoader();
        ...
        container = document.createElement( 'div' );
                ...
                // DEBUG: Add a visible test cube at the origin
                ...
                scene.add(debugCube);
                console.log('initGraphics: Scene, camera, renderer, and debug cube initialized.');
			}
...
//
     ...
     function onWindowResize() {
        ...
        movingfunction();
				stats.update();
        console.log('animate: Animation frame rendered.');
			}
